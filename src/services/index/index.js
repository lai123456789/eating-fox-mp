...
// 获取商品详情
const apiGetGoodsDetailsF = (goodsId,si,sk,qrScene,room_id,fun) => packagePromise((resolve, reject) => {
  request({
    url: apiGetGoodsDetails(goodsId,si,sk,qrScene,room_id),
    method: 'GET'
  }, fun)
    .then(msg => {
      resolve(msg)
...
// 获取团购信息
const apiGroupInfoF = (groupId, fun) => packagePromise((resolve, reject) => {
  request({
    url: apiGroupInfo(groupId),
    method: 'GET',
  }, fun)
    .then(msg => {
      resolve(msg)
