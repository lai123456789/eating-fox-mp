...
// 商品分类模块 => 分类【tab】
const apiCategoryByParent = (parentId) => `${MAIN_DOMAIN}/api/goods/category/find_by_parentid/${parentId}`

// 商品分类模块 => 获取分类页面的banner信息
const apiCategoryGetBanner = () => `${MAIN_DOMAIN}/api/goods/category/get_banner`
