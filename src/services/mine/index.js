...
// 订单模块 => 分页查询待发货订单列表
const apitoBeDeliveredF = (data, fun) => packagePromise((resolve, reject) => {
  request({
    url: apitoBeDelivered(),
    method: 'POST',
    noOutData: true,
    data
  }, fun)
...
// 订单模块 => 分页查询待付款订单列表
const apipendingPaymentF = (data, fun) => packagePromise((resolve, reject) => {
  request({
    url: apipendingPayment(),
    method: 'POST',
    noOutData: true,
    data
  }, fun)
...
// 订单模块 => 分页查询待收货订单列表
const apitoReceivedF = (data, fun) => packagePromise((resolve, reject) => {
  request({
    url: apitoReceived(),
    method: 'POST',
    noOutData: true,
...
// 订单模块 => 分页查询待评价订单列表
const apitoCommentF = (data, fun) => packagePromise((resolve, reject) => {
  request({
    url: apitoComment(),
    method: 'POST',
    noOutData: true,
...
const apiGetHearderF = (fun) => packagePromise((resolve, reject) => {
  request({
    url: apiGetHearder(),
    method: 'GET',
  }, fun)
...
const apiExpressCompanyF = (fun) => packagePromise((resolve, reject) => {
  request({
...
// 商品售后模块 => 获取售后服务单列表 1-处理中  2-待评价 3-所有申请记录 （原先2为处理中 3为待评价 不传就是所有记录）
...
// 商品售后订单 => 查看售后订单详情
const apiAfterSaleInfoF = (orderDetailId,fun) => packagePromise((resolve, reject) => {
  request({
    url: apiAfterSaleInfo(orderDetailId),
    method: 'GET',
  }, fun)
    .then(msg => {
      resolve(msg)
...
// 商品售后订单 => 确认签收
const apiAfterSaleSignOrderF = (id,fun) => packagePromise((resolve, reject) => {
  request({
    url: apiAfterSaleSignOrder(id),
    method: 'POST',
  }, fun)
    .then(msg => {
      resolve(msg)
...
// 获取账户余额信息
const apiGetAccountMoneyF = (fun) => packagePromise((resolve, reject) => {
  request({
    url: apiGetAccountMoney(),
    method: 'GET'
  }, fun)
    .then(msg => {
      resolve(msg)
...
// 获取统计邀请的会员数
const apiInviteNumF = (fun) => packagePromise((resolve, reject) => {
  request({
    url: apiInviteNum(),
    method: 'GET'
  }, fun)
...
// 获取预估数据信息
const apiEstimatedDataF = (fun) => packagePromise((resolve, reject) => {
  request({
    url: apiEstimatedData(),
    method: 'GET'
  }, fun)
    .then(msg => {
      resolve(msg)
...
// 获取订单统计数量num
const apiGetstatisticsApiF = (fun) => packagePromise((resolve, reject) => {
  request({
    url: apiGetstatisticsApi(),
    method: 'GET'
  }, fun)
    .then(msg => {
      resolve(msg)
...
// 获取直播房间列表
const apiGetRoomListF = (fun) => packagePromise((resolve, reject) => {
  request({
    url: apiGetRoomList(),
    method: 'GET'
  }, fun)
...
// 获取 用户提现记录
const apiwithdrawRecordF = (data, fun) => packagePromise((resolve, reject) => {
  request({
    url: apiwithdrawRecord(),
    method: 'POST',
    noOutData: true,
    data
  }, fun)
...
// 获取 用户账户余额流水
const apiaccountRecordF = (data, fun) => packagePromise((resolve, reject) => {
  request({
    url: apiaccountRecord(),
    method: 'POST',
    noOutData: true,
    data
  }, fun)
...
// 获取 用户邀请的会员列表
const apiGetInviteListF = (data, fun) => packagePromise((resolve, reject) => {
  request({
    url: apiGetInviteList(),
    method: 'POST',
    noOutData: true,
    data
  }, fun)
...
// 获取 用户返利的数据
const apiGetUserCashbackDataF = (data, fun) => packagePromise((resolve, reject) => {
  request({
    url: apiGetUserCashbackData(),
    method: 'POST',
    noOutData: true,
    data
  }, fun)
...
// 获取 邀请码 分享图片
const apiGetMyShareF = (fun) => packagePromise((resolve, reject) => {
  request({
    url: apiGetMyShare(),
    method: 'POST'
  }, fun)
...
export {
  ...
  apiGetstatisticsApiF,
  apitoBeDeliveredF,
  apipendingPaymentF,
  apitoReceivedF,
  apitoCommentF,
  apiAfterSaleSignOrderF,
  apiGetAccountMoneyF,
  apiEstimatedDataF,
  apiInviteNumF,
  apiGetInviteListF,
  apiGetUserCashbackDataF,
  apiwithdrawRecordF,
  apiaccountRecordF,
  apiGetMyShareF,
  apiGetRoomListF
